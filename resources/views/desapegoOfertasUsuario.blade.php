...
<section class="container d-flex align-items-center flex-column h-auto">
    ...
    <div class="img-ofertaDesapegoHistorico h-auto">
        ...
        <div class="card col-4 cardOfertaDesapego">
            ...
            <img src="{{asset('storage/'.$oferta->image)}}" style="height:55vh; margin-bottom: 10px;margin-top: 10px;"
                alt="">


            <h5 class="card-title">{{$oferta -> descriptionProduct}}</h5>
            <strong>
                <h5 class="card-text">R$ {{$oferta -> priceProduct}} </h5>
            </strong><br>

            <div class="d-flex flex-row">
                <a href="{{route('ofertaDesapego.edit', $oferta -> id)}}" class="btn btnSurf mr-1">Editar</a>
    ...
    <div class="container mt-3 p-3">
        <a href='#historicoOfertasTopo' class="btn btnSurf">Topo</a>
        <a href="/desapego" class="btn btnSurf">Voltar</a>
    </div>
